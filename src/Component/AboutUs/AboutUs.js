...
const AboutUs = (props) => {
    ...
    return(
      ...
      <div id="signintext2">
          <h2 className="looking2"><em>Arch Arrivals assists people in finding events happening in the St. Louis area!</em></h2>
      ...
      <img id="todointhelou" src={todointhelou} className="bd-placeholder-img card-img-top" style={{ width: '100%'}} alt="" />
        ...
        <footer className="container" id="aboutUsFooterContainer">
          ...
          <p id="foot2">New to Arch Arrivals? Sign up & find STL events <a href="/">Here</a>!</p>
        </footer>
